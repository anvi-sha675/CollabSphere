...
export async function acceptFriendRequest(req, res){
    try {
        ...
        //add each user to others friend req only if this does not exist
...
export async function getFriendRequests(req, res){
    try {
        const incomingReqs= await FriendRequest.find({
            ...
            status:"pending",
        }).populate("sender", "fullName profilePic nativeLanguage progarmmingLanguage");
...
export async function getOutgoingFriendReqs(req, res){
    try {
        const outgoingRequests = await FriendRequest.find({
            sender: req.user.id,
            status: "pending",
        }).populate("recipient", "fullName profilePic nativeLanguage programmingLanguage");
